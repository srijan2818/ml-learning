...
- Bias : GD converges to the global minimizer that is Euclidean-closest to the initialization point (without regularisation), On linear models it finds the max-margin solution
